...
from .inline import LatexAnchorRegistry, escape_latex_text, escape_latex_url, render_inline_spans, render_joined_inline_contents
...
_PREAMBLE_LINES = (
    "% !TeX program = xelatex",
    "% Generated by DocVortex. Compile with: latexmk -xelatex <file>.tex",
    ...
    r"\definecolor{DocVortexGray}{HTML}{6B7280}",
    r"\definecolor{DocVortexSurface}{HTML}{F3F4F6}",
    r"\definecolor{DocVortexTableHeader}{HTML}{E5E7EB}",
    ...
    r"\newcommand{\DocVortexLineBreak}{\leavevmode\hfill\break}",
    r"\newcommand{\DocVortexPlaceholder}[1]{\fcolorbox{DocVortexGray}{DocVortexSurface}{\textit{#1}}}",
)
...
class _LatexRenderer:
    ...
    def _render_verbatim(self, content: str) -> str:
        ...
        while True:
            ...
            environment = f"DocVortexVerbatim{self.verbatim_counter}"
