...
__all__ = [
    "normalize_page_size",
    "bbox_to_pixel_bbox",
    "normalize_layout_bbox_to_unit",
    "medium_bbox_to_quad",
    "normalize_medium_content",
    "table_bbox_center",
    "normalize_visual_block_angle",
    "rotate_visual_block_image_to_upright",
    "rotate_medium_table_bbox",
    "get_medium_table_virtual_image_bbox",
    "encode_page_crop_as_jpeg_data_uri",
    "sidecar_bbox_to_page_bbox",
]
