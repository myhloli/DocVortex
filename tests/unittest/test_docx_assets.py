...
from docvortex.render._internal.docx.assets import (
    DocxAssetError,
    PreparedImage,
    prepare_block_image,
    prepare_html_image,
...
from docvortex.schema import ImageBodyBlock
...
def test_generated_svg_rejects_dtd_beyond_prefix_window() -> None:
    ...
    with pytest.raises(DocxAssetError, match="safely generated by DocVortex"):
