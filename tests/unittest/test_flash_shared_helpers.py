...
from docvortex.analyzers.native._shared.image import image_to_b64str, image_to_bytes
...
from docvortex.analyzers.native.office.legacy.binary import bounded_slice, get_f64, get_i16, get_u16, get_u32
from docvortex.analyzers.native.office.opc import relationship_source_base_dir, write_zip_package
from docvortex.analyzers.native.office.ppt import records as ppt_records
from docvortex.analyzers.native.office.rich_text import OfficeRichTextSegment, build_rich_text_from_segments
