...
from docvortex.render import render_markdown, render_structured_content
...
def test_structured_content_keeps_chart_content_separate_from_base64_source(
    ...
    output = render_structured_content(_middle(_page(0, chart)), latex_delimiters=configured)["pages"][0]["blocks"][0]
...
def test_structured_content_renders_equation_as_raw_latex_with_single_image_source(
    ...
    blocks = render_structured_content(middle, latex_delimiters=configured, asset_base_url="https://cdn.example/doc")["pages"][
        0
    ]["blocks"]
